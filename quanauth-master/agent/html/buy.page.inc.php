...
<div class="layui-row layui-col-space10 my-index-main">
    <form class="layui-form" action="">
        ...
        <div class="layui-form-item">
            <label for="kt_mail" class="layui-form-label"><B><font color="red">授权IP</font></B></label>
            <div class="layui-input-block">
                <input class="layui-input" name="kt_mail" placeholder="填写服务器ip地址" type="text">
            </div>
        </div>
        <div class="layui-form-item">
            <label for="kt_adminqq" class="layui-form-label"></label>
            <div class="layui-input-block">
                <input class="layui-input" name="kt_adminqq" placeholder="无需填写此项" type="text">
            </div>
        </div>
        ...
        <div class="layui-form-item" id="show_zxzf">
            ...
            <div class="layui-input-block">
                <input type="radio" name="zxzffs" value="zfb" title="" checked>
                <input type="radio" name="zxzffs" value="wx" title="">
                <input type="radio" name="zxzffs" value="qq" title="">
            </div>
        </div>
